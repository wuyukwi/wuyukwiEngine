...
struct GfxConfiguration {
    ...
    GfxConfiguration(uint32_t r = 8, uint32_t g = 8,
        ...
        uint32_t width = 1280, uint32_t height = 720, bool fullscreen = false,
        const char* app_name = "GameEngine",
        const char* app_class_name = "WindowsClass",
        const char* sound_path = "sounds/",
        const char* sound_file = "sounds/soundsList.txt") :
        ...
        appName(app_name), winClassName(app_class_name), soundPath(sound_path), soundFile(sound_file)
    {}
